...
ki10 = LINETCR.LINE()
ki10.login(token="NEW")
ki10.loginResult()

ki18 = LINETCR.LINE()
ki18.login(token="NEW")
ki18.loginResult()
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage ="""=====[T&Z TEAM BOT]=====
...
=====[T&Z TEAM BOT]=====
"""
KAC=[cl,ki,ki2,ki3,ki4,ki5,ki6,ki7,ki8,ki9,ki10,ki18]
...
Bots=[mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,ki6mid,ki7mid,ki8mid,ki9mid,ki10mid,ki18mid]
admsa = "MID HERE UIN OKE"
...
≫busy time at 08:00 - 16:00 ≪
Ready:
≫ bot protect ≪≫ SelfBot ≪≫ Tickets siriV10 ≪
SUPPORT BY:
PSD T&Z TEAM BOT
Minat?PM!
    ...
    try:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                cl.sendMessage(msg)
            elif msg.text.lower() == 'rian':
                msg.contentType = 13
                msg.contentMetadata = {'mid': mid}
                cl.sendMessage(msg)
            elif msg.text.lower() == 'rn1':
                msg.contentType = 13
                msg.contentMetadata = {'mid': kimid}
                ki.sendMessage(msg)
            elif msg.text.lower() == 'rn2':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki2mid}
                ki2.sendMessage(msg)
            elif msg.text.lower() == 'rn3':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki3mid}
                ki3.sendMessage(msg)
            elif msg.text.lower() == 'rn4':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki4mid}
                ki4.sendMessage(msg)
            elif msg.text.lower() == 'rn5':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki5mid}
                ki5.sendMessage(msg)
            elif msg.text.lower() == 'rn6':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki6mid}
                ki6.sendMessage(msg)
            elif msg.text.lower() == 'rn7':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki7mid}
                ki7.sendMessage(msg)
            elif msg.text.lower() == 'rn8':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki8mid}
                ki8.sendMessage(msg)
            elif msg.text.lower() == 'rn9':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki9mid}
                ki9.sendMessage(msg)
            elif msg.text.lower() == 'rn10':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki10mid}
                ki10.sendMessage(msg)
            elif msg.text.lower() == 'rn18':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki18mid}
            ...
            elif msg.text.lower() == 'Rn mid':
                ki.sendText(msg.to,kimid)
            elif msg.text.lower() == 'Rn2 mid':
                ki2.sendText(msg.to,ki2mid)
            elif msg.text.lower() == 'Rn3 mid':
                ki3.sendText(msg.to,ki3mid)
            elif msg.text.lower() == 'Rn4 mid':
                ki4.sendText(msg.to,ki4mid)
            elif msg.text.lower() == 'Rn5 mid':
                ...
                if len(string.decode('utf-8')) <= 500:
                    ...
                    profile.statusMessage = string
                    ki18.updateProfile(profile)
                    cl.sendText(msg.to,"biodata dirubah menjadi " + string + "")
                if msg.text == "lurking":
...
#--------------------------------------------------------
                ...
                if len(string.decode('utf-8')) <= 500:
                    ...
                    profile.statusMessage = string
                    cl.updateProfile(profile)
                    cl.sendText(msg.to,"Di Update Bio👉" + string + "")
#--------------------------------------------------------
                ...
                start = time.time()
                cl.sendText(msg.to, "Starting Waiting Answer...")
                ...
                for i in gid:
                    ...
                    ki18.leaveGroup(i)
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"PSD T&Z TEAM BOT PAMIT MAU PULANG")
                else:
...
#-----------------------------------------------------------
                   ...
                   for target in targets:
                       try:
                           ...
                           ki5.sendText(msg.to,"Error")
            elif ("Chekk " in msg.text):
                   key = eval(msg.contentMetadata["MENTION"])
                   key1 = key["MENTIONEES"][0]["M"]
                   mi = cl.getContact(key1)
                   cl.sendText(msg.to,"Mid:" +  key1)

            elif "Mbem " in msg.text:
                if msg.toType == 2:
...
#-----------------------------------------------------------
			   ...
			   cl.sendText(msg.to,"Hadiah kirim ke dia jangan lupa ya")
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"""      􀠁􀆩􏿿􀠁􀆩􏿿 PSD TEAM BOT [T&Z] 􀠁􀆩􏿿􀠁􀆩􏿿  \n\n 􀠁􀆩􏿿 key Only Kicker 􀠁􀆩􏿿 \n\n􀠁􀆩􏿿[Tm1 in]\n􀠁􀆩􏿿[1name:]\n􀠁􀆩􏿿[B Cancel]\n􀠁􀆩􏿿[kick @]\n􀠁􀆩􏿿[Ban @]\n􀠁􀆩􏿿[kill]\n􀠁􀆩􏿿[BotChat]\n􀠁􀆩􏿿[Responsename]\n􀠁􀆩􏿿[Bot1 Gift]\n􀠁􀆩􏿿[Tm1 bye]\n\n
...
#-----------------------------------------------
                ...
                ginfo = cl.getGroup(msg.to)
                cl.sendText(msg.to,"Welcome in room me " + str(ginfo.name))
